...
<body class="fixed-header" onLoad="disableClick()">
	...
	<!-- wrapper -->
	<div id="wrapper">
		<section class="hero hero-games height-300 section parallax bg1" style="background-image: url(img/slideshow/bollyCover.jpg);">
		<?php
...
?>
			...
			<div class="container">
				<div class="page-header">
					<div class="page-title bold" STYLE="font-family:Montserrat">Bollywood Movies</div>
					<p>All Bollywood movies available at freeland are 100% free, if any Bollywood movie is not available at Freeland then contact to admin.</p>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
								...
								<?php
									...
									$sql='SELECT * FROM movies WHERE m_category="bollywood" ORDER BY m_id desc LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
									$result = mysqli_query($con, $sql);
