...
?>	
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/movImages/nma2/nma21.jpg)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title">
						<?php
								$sql='SELECT * FROM movies WHERE m_id=3';
			...
			<div class="container">
				<div class="row">
						...
						<div class="panel panel-default panel-post">
							...
							?>
									...
									<div class="embed-responsive embed-responsive-16by9 post-thumbnail">
										<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/rHGrATsrwzs" allowfullscreen></iframe>
									</div>
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/movImages/nma2/nma21.jpg);">
							<div class="overlay">
								<div class="title">
									<?php
								$sql='SELECT * FROM movies WHERE m_id=3';
						...
						<div class="widget widget-list">
							...
							<div class="tab-content">
								<ul class="tab-pane fade in active" id="tabs1">
									...
									$sql='SELECT * FROM movies WHERE m_category="pakistan" ORDER BY m_id desc LIMIT 5';
									$result = mysqli_query($con, $sql);
									while($row = mysqli_fetch_array($result)) 
									{
									echo "<li>";
