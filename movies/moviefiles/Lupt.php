...
?>	
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/movImages/lupt/lupt2.jpg)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title">
						<?php
								$sql='SELECT * FROM movies WHERE m_id=2';
			...
			<div class="container">
				<div class="row">
						...
						<div class="panel panel-default panel-post">
							...
							?>
									...
									<div class="embed-responsive embed-responsive-16by9 post-thumbnail">
										<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/IrvtrGuqDnY" allowfullscreen></iframe>
									</div>
									<h3><b>Description:</b></h3>
									<div class="wp-tab-content">		
										Lupt is an 2018 Indian Hindi-language supernatural horror film starring Javed Jaffrey, Niki Aneja Walia and Vijay Raaz. The film is directed by Prabhuraj.The story revolves around Harsh who is a ruthless businessman and his family.				
									</div>
								</div>
							</div>
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/movImages/lupt/lupt1.jpg);">
							<div class="overlay">
								<div class="title">
									<?php
								$sql='SELECT * FROM movies WHERE m_id=2';
						...
						<div class="widget widget-list">
							...
							<div class="tab-content">
								<ul class="tab-pane fade in active" id="tabs1">
									...
									$sql='SELECT * FROM movies WHERE m_category="bollywood" ORDER BY m_id desc LIMIT 5';
									$result = mysqli_query($con, $sql);
									while($row = mysqli_fetch_array($result)) 
									{
									echo "<li>";
