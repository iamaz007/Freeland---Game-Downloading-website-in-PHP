...
?>	
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/movImages/Bumblebee/Bumblebee.jpg)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title">
						<?php
								$sql='SELECT * FROM movies WHERE m_id=7';
			...
			<div class="container">
				<div class="row">
						...
						<div class="panel panel-default panel-post">
							...
							?>
											...
											<ul class="post-meta">
												...
												<li><i class="fa fa-calendar-o"></i> Uploaded on: 20 Jan, 2019</li>
									...
									<div class="embed-responsive embed-responsive-16by9 post-thumbnail">
										<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/fAIX12F6958" allowfullscreen></iframe>
									</div>
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/movImages/Bumblebee/Bumblebee.jpg);">
							<div class="overlay">
								<div class="title">
									<?php
								$sql='SELECT * FROM movies WHERE m_id=7';
