...
?>	
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/movImages//.jpg)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title">
						<?php
								$sql='SELECT * FROM movies WHERE m_id=';
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/movImages//.jpg);">
							<div class="overlay">
								<div class="title">
									<?php
								$sql='SELECT * FROM movies WHERE m_id=';
						...
						<div class="widget widget-list">
							...
							<div class="tab-content">
								<ul class="tab-pane fade in active" id="tabs1">
									...
									$sql='SELECT * FROM movies WHERE m_category="" ORDER BY m_id desc LIMIT 5';
									$result = mysqli_query($con, $sql);
									while($row = mysqli_fetch_array($result)) 
									{
									echo "<li>";
