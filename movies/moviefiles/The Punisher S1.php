...
?>	
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/movImages/punishers1/punishers1.jpg)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title">
						<?php
								$sql='SELECT * FROM movies WHERE m_id=5';
						...
						<div class="panel panel-default panel-post">
							...
							?>
									...
									<div class="embed-responsive embed-responsive-16by9 post-thumbnail">
										<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/lIY6zFL95hE" allowfullscreen></iframe>
									</div>
...
” the Punisher”, who aims to fight crime by any means necessary.				
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/movImages/punishers1/punishers1.jpg);">
							<div class="overlay">
								<div class="title">
									<?php
								$sql='SELECT * FROM movies WHERE m_id=5';
