...
?>
			...
			<div class="container">
				<div class="page-header">
					<div class="page-title bold" STYLE="font-family:Montserrat">Hollywood Movies</div>
					<p>All Hollywood movies available at freeland are 100% free, if any hollywood movie is not available at Freeland then contact to admin.</p>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
								...
								<?php
									...
									$sql='SELECT * FROM movies WHERE m_category="hollywood" ORDER BY m_id desc LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
									$result = mysqli_query($con, $sql);
