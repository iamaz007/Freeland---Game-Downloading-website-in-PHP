...
<body class="fixed-header" id="home" onLoad="disableClick()">
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/slideshow/searchCover.jpg)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title"><a href="HollywoodMovies">Movies and Tv series</a></div>
							...
							<div class="panel-body">
								...
								<?php
									if (isset($_POST['submit']))
									{
										...
										$sql = "SELECT * FROM movies WHERE m_keyword LIKE '%$search%' ORDER BY m_id desc";
										...
										echo "<div id='img_div'>";
												...
												<a href='moviefiles/".$row{'m_title'}.".php? data-toggle='tooltip' target='blank' title=".$row['m_title']."'>".$row['m_title']."</h3></div></a>";
											  echo "</div>";
											  echo "</div>";
											  echo "</div>";
											  echo "</div>";
										...
										else
										{
											...
											echo "<h4>Or may be you are searching any game or software.</h4>";
											echo "<h5>Click <a href=''>Here</a> to go to Game Section</h5>";
											echo "<h5>Click <a href=''>Here</a> to go to Software Section</h5>";
										}
									}
								?>
