...
?>	
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/game/pcgame//.jpg)">
			...
			<div class="container">
				<div class="row">
									...
									<div class="post-header post-author">
										...
										<div class="post-title">
											...
											<ul class="post-meta">
												...
												<li><i class="fa fa-calendar-o"></i> Uploaded on: </li>
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/game/pcgame//.jpg);">
							<div class="overlay">
								<div class="title">
								<?php
								$sql='SELECT * FROM article WHERE a_id=';
								...
								<span id="dw" class="font-size-13"> GB</span>
						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								<a href="" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PC ( GB)</a>
								<a href="" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PS ( GB)</a>
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							  </div>
						...
						<div class="widget widget-list">
							...
							<div class="tab-content">
								<ul class="tab-pane fade in active" id="tabs1">
									...
									$sql='SELECT * FROM article WHERE a_category="" ORDER BY a_id desc LIMIT 5';
									$result = mysqli_query($con, $sql);
									while($row = mysqli_fetch_array($result)) 
									{
									echo "<li>";
