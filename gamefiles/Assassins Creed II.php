...
?>	
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/game/pcgame/ac2/ac.jpg)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title">Assassins Creed II</div>
			...
			<div class="tab-select text-center sticky">
				<div class="container">
					<ul class="nav nav-tabs">
						...
						<li class="active" ><a href="#home">Assassins Creed II</a></li>
		...
		<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			  <div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<h5 style="color:black;" class="modal-title" id="exampleModalLongTitle">Assassins Creed II Windows System Requirments</h5>
				  </div>
						  <div class="container" style="color:black;">
							<div class="row">
								<div class="col-md-9 padding-right-20">
										<b>Minimum:</b>
										<h5>• OS: Windows® XP (32-64 bits) /Windows Vista®(32-64 bits)/Windows 7® (32-64 bits)</h5>
										<h5>• CPU: Intel Core® 2 Duo 1.8 GHZ or AMD Athlon X2 64 2.4GHZ</h5>
										<h5>• RAM: 2 GB</h5>
										<h5>• Graphics: 256 MB DirectX® 9.0–compliant card with Shader Model 3.0 or higher</h5>
										<h5>• HARD DRIVE: 8 GB</h5>
										
										<b>Recommended:</b>
										<h5>• OS: Windows® XP (32-64 bits) /Windows Vista®(32-64 bits)/Windows 7® (32-64 bits) </h5>
										<h5>• CPU: Intel Core® 2 Duo E6700 2.6 GHz or AMD Athlon 64 X2 6000+ or better</h5>
										<h5>• RAM: 2 GB</h5>
										<h5>• Graphics: GeForce 8800 GT or ATI Radeon HD 4700 or better</h5>
										<h5>• HARD DRIVE: 8 GB</h5>
								...
								<div class="post">
									<div class="post-header post-author">
										...
										<div class="post-title">
											<h3><a href="#">Assassins Creed II</a></h3>
											<ul class="post-meta">
									...
									<div class="embed-responsive embed-responsive-16by9 post-thumbnail">
										<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/_xkCPNECud8" allowfullscreen></iframe>
									</div>
									<h3><b>Description:</b></h3>
									<div class="wp-tab-content">		
										<div class="wp-tab-content-wrapper">Assassin’s Creed® 2 is the follow-up to the title that became the fastest-selling new IP in video game history. The highly anticipated title features a new hero, Ezio Auditore da Firenze, a young Italian noble, and a new era, the Renaissance. Assassin’s Creed 2 retains the core gameplay experience that made the first opus a resounding success and features new experiences that will surprise and challenge players. Assassin’s Creed 2 is an epic story of family, vengeance and conspiracy set in the pristine, yet brutal, backdrop of a Renaissance Italy. Ezio befriends Leonardo da Vinci, takes on Florence’s most powerful families and ventures throughout the canals of Venice where he learns to become a master assassin.<p></p>
<p>Repack Features:<br>
• Languages: -Voice: English | -Text: Multi<br>
• Repack Size: 2.80 GB<br>
• Game Size: 5.31 GB<br>
• Size Required: 6.00 GB<br>
• Audio Quality: Untouched<br>
• Video Quality: Untouched<br>
• Texture Quality: Untouched<br>
• Ripped / Removed: Nothing<br>
• Based On: SKIDROW release</p></div>				
									</div>
									<div id="ss"></div>
									<h3><b><a>Screen Shots:</a></b></h3>
									<div class="img-responsive">
										<img src="img/game/pcgame/ac2/ac21.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/ac2/ac22.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/ac2/ac23.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/ac2/ac24.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/ac2/ac25.jpg">
									</div>	
								</div>
							</div>
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/game/pcgame/ac2/ac.jpg);">
							<div class="overlay">
								<div class="title">Assassins Creed II</div>
								...
								<span class="font-size-13">Mar 9, 2010</span>
								
								<div class="bold text-uppercase margin-top-35">Setup</div>
								<span class="font-size-13">Assassins Creed II Repack-CorePack</span>
								
								<div class="bold text-uppercase margin-top-35">Size</div>
								<span id="dw" class="font-size-13">2.80 GB</span>
								
								<div class="bold text-uppercase margin-top-35">Crack by</div>
								<span class="font-size-13">SKIDROW</span>
						...
						<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  <div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">Assassins Creed II Download Links</h5>
							  </div>
							  <div class="modal-body">
								<a href="http://filecrypt.cc/Container/C550E24E00.html" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PC (2.80 GB)</a>
								<a href="https://goo.gl/j2GaUd" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PS3 (6 GB)</a>
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							  </div>
