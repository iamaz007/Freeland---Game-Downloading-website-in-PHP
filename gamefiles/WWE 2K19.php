...
?>	
	...
	<meta name="title" content="WWE 2K19 | Freeland">
	<meta name="description" content="">
	<meta name="keyword" content="WWE 2K19 free download, WWE 2K19 crack only download, WWE 2K19 crack, WWE campagin, WWE walkthrough">
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/game/pcgame/wwe19/wwe195.jpg)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title">
							<?php
								$sql='SELECT * FROM article WHERE a_id=65';
...
• OS: 64-bit: Windows® 7 (latest updates)<br>
• Processor: Intel Core i5-3550 / AMD FX 8150<br>
• Memory: 4 GB RAM<br>
• Graphics: GeForce GTX 670 / Radeon HD 7850<br>
• Storage: 50 GB<br>
<p>Recommended:<br>
• Requires a 64-bit processor and operating system<br>
• OS: 64-bit: Windows® 7, Windows® 8 (8.1) or Windows® 10 (latest updates)<br>
• Processor: Intel Core i7 3770 / AMD FX-8350<br>
• Memory: 8 GB RAM<br>
• Graphics: Nvidia GPU GeForce GTX 970 / AMD GPU Radeon R9 290X<br>
• Storage: 50 GB<br></p>
							...
							<div class="panel-body">
								<div class="post">
									...
									<div class="embed-responsive embed-responsive-16by9 post-thumbnail">
										<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/OzvNPIs39QQ" allowfullscreen></iframe>
									</div>
									<h3><b>Description:</b></h3>
									<div class="wp-tab-content">		
										<div class="wp-tab-content-wrapper">WWE 2K19 arrives as the latest entry to the flagship WWE video game franchise and features cover Superstar AJ Styles. WWE 2K19 will showcase a massive roster of popular WWE Superstars, Legends and Hall of Famers, as well as NXT favorites. Experience authentic WWE gameplay, extensive creation options, engaging match types, fan-favorite modes and much more!<p></p>
<p>Available NEW! DLC for this release:<br>
• (Update v1.02) – WWE 2K19 – Titans Pack</p></div>				
									</div>
									<div id="ss"></div>
									<h3><b><a>Screen Shots:</a></b></h3>
									<div class="img-responsive">
										<img src="img/game/pcgame/wwe19/wwe191.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/wwe19/wwe192.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/wwe19/wwe193.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/wwe19/wwe194.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/wwe19/wwe195.jpg">
									</div>	
								</div>
							</div>
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/game/pcgame/wwe19/wwe194.jpg);">
							<div class="overlay">
								<div class="title">
								<?php
								$sql='SELECT * FROM article WHERE a_id=65';
								...
								<span class="font-size-13">Visual Concepts</span>
								...
								<span class="font-size-13">9 Oct, 2018</span>
								
								<div class="bold text-uppercase margin-top-35">Setup</div>
								<span class="font-size-13">WWE 2K19-CODEX</span>
								
								<div class="bold text-uppercase margin-top-35">Size</div>
								<span id="dw" class="font-size-13">42.8 GB</span>
						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								<a href="https://filecrypt.cc/Container/7D3FD0E15E.html" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PC (42.8 GB)</a>
								<a href="https://filecrypt.cc/Container/50E1D673B2.html" class="btn btn-block btn-primary margin-top-40" target="_blank">WWE 2K19 Update v1.02 incl DLC-CODEX</a>
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							  </div>
						...
						<div class="widget widget-list">
							...
							<div class="tab-content">
								<ul class="tab-pane fade in active" id="tabs1">
									...
									$sql='SELECT * FROM article WHERE a_category="fighting" ORDER BY a_id desc LIMIT 5';
									$result = mysqli_query($con, $sql);
									while($row = mysqli_fetch_array($result)) 
									{
									echo "<li>";
