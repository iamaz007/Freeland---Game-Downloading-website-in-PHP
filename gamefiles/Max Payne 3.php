...
?>	
	...
	<meta name="title" content="Max Payne 3 | Freeland">
	<meta name="keyword" content="Max Payne 3 crack, codex crack, fitgirl dwonlaod">
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/game/pcgame/maxp3/maxp31.jpg)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title">
							<?php
								$sql='SELECT * FROM article WHERE a_id=67';
...
• Memory: 2 Gb<br>
• Hard Drive: 35 Gb free<br>
• Video Memory: 512 Mb<br>
• Video Card: nVidia GeForce 8600 / ATI Radeon HD 3450<br>
<p>Recommended:<br>
• OS: Windows Vista/7<br>
• Processor: Intel Core i3 @ 3.06 GHz / AMD FX-8150 @ 3.6 GHz<br>
• Memory: 8 Gb<br>
• Hard Drive: 35 Gb free<br>
• Video Memory: 2 Gb<br>
• Video Card: nVidia GeForce GTX 680 / ATI Radeon HD 7970<br>
</p>
							...
							<div class="panel-body">
								<div class="post">
									<div class="post-header post-author">
										...
										<div class="post-title">
											...
											<ul class="post-meta">
												...
												<li><i class="fa fa-calendar-o"></i> Uploaded on: 3 Dec, 2018</li>
									...
									<div class="embed-responsive embed-responsive-16by9 post-thumbnail">
										<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/4Uc_dbG7MR8" allowfullscreen></iframe>
									</div>
									<h3><b>Description:</b></h3>
									<div class="wp-tab-content">		
										<div class="wp-tab-content-wrapper">For Max Payne, the tragedies that took his loved ones years ago are wounds that refuse to heal. No longer a cop, close to washed up and addicted to pain killers, Max takes a job in São Paulo, Brazil, protecting the family of wealthy real estate mogul Rodrigo Branco, in an effort to finally escape his troubled past. But as events spiral out of his control, Max Payne finds himself alone on the streets of an unfamiliar city, desperately searching for the truth and fighting for a way out.<p></p>
<p>Combining cutting edge shooting mechanics with a dark and twisted story, Max Payne 3 is a seamless, highly detailed, cinematic experience from Rockstar Games.</p>
<p>The Complete Edition includes:<br>
• Max Payne 3 (main game)<br>
• Max Payne 3: Deathmatch Made In Heaven Pack (DLC)<br>
• Max Payne 3: Painful Memories Pack (DLC)<br>
• Max Payne 3: Hostage Negotiation Pack (DLC)<br>
• Max Payne 3: Local Justice Pack (DLC)<br>
• Max Payne 3: Silent Killer Loadout Pack (DLC)<br>
• Max Payne 3: Cemetery Map (DLC)<br>
• Max Payne 3: Special Edition Pack (DLC)<br>
• Max Payne 3: Deadly Force Burst (DLC)<br>
• Max Payne 3: Pill Bottle Item (DLC)</p></div>				
									</div>
									<div id="ss"></div>
									<h3><b><a>Screen Shots:</a></b></h3>
									<div class="img-responsive">
										<img src="img/game/pcgame/maxp3/maxp31.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/maxp3/maxp32.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/maxp3/maxp33.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/maxp3/maxp34.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/maxp3/maxp35.jpg">
									</div>	
								</div>
							</div>
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/game/pcgame/maxp3/maxp32.jpg);">
							<div class="overlay">
								<div class="title">
								<?php
								$sql='SELECT * FROM article WHERE a_id=67';
								...
								<span class="font-size-13">Rockstar Studios</span>
								
								<div class="bold text-uppercase margin-top-40">Publisher</div>
								<span class="font-size-13">Rockstar Games</span>
								
								<div class="bold text-uppercase margin-top-35">Release Date</div>
								<span class="font-size-13">Nov 22, 2012</span>
								
								<div class="bold text-uppercase margin-top-35">Setup</div>
								<span class="font-size-13">Max Payne 3 Complete Edition-RELOADED</span>
								
								<div class="bold text-uppercase margin-top-35">Size</div>
								<span id="dw" class="font-size-13">29.8 GB</span>
						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								<a href="http://filecrypt.cc/Container/1BA26387BE.html" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PC (29.8 GB)</a>
								<a href="https://goo.gl/9BUxYr" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PS3 (12.7 GB)</a>
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							  </div>
