...
?>	
	...
	<meta name="title" content="Battlefield V | Freeland">
	<meta name="description" content="Download Battlefield V for free with direct Google Drive links free from Freeland">
	<meta name="keyword" content="Battlefield V, Battlefield V campaign, Battlefield V free download, Battlefield V crack, Battlefield V cpy, ova games">
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/game/pcgame/bfv/bfv7.png)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title">
							<?php
								$sql='SELECT * FROM article WHERE a_id=70';
...
• Processor (AMD): AMD FX-8350<br>
• Processor (Intel): Core i5 6600K<br>
• Memory: 8GB RAM<br>
• Graphics card (NVIDIA): NVIDIA GeForce® GTX 1050 / NVIDIA GeForce® GTX 660 2GB<br>
• Graphics card (AMD): AMD Radeon™ RX 560 / HD 7850 2GB<br>
• Hard-drive space: 50GB<p></p>
<p>Recommended:<br>
• OS: 64-bit Windows 10 or later<br>
• Processor (AMD): AMD Ryzen 3 1300X<br>
• Processor (Intel): Intel Core i7 4790 or equivalent<br>
• Memory: 12GB RAM<br>
• Graphics card (NVIDIA): NVIDIA GeForce® GTX 1060 6GB<br>
• Graphics card (AMD): AMD Radeon™ RX 580 8GB<br>
• Disk Space: 50GB</p>
			...
			<div class="container">
				<div class="row">
							...
							<div class="panel-body">
								<div class="post">
									<div class="post-header post-author">
										...
										<div class="post-title">
											...
											<ul class="post-meta">
												...
												<li><i class="fa fa-calendar-o"></i> Uploaded on: 12 Dec, 2018</li>
									...
									<div class="embed-responsive embed-responsive-16by9 post-thumbnail">
										<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/9OTkhsJUK0U" allowfullscreen></iframe>
									</div>
									<h3><b>Description:</b></h3>
									<div class="wp-tab-content">		
											The Battlefield series goes back to its roots in a never-before-seen portrayal of World War 2. 
											Take on all-out multiplayer with your squad in modes like the vast Grand Operations and the cooperative 
											Combined Arms, or witness human drama set against global combat in the single-player War Stories. 
											...
											• Based on Battlefield.V-CPY (54,286,557,184 bytes)<br>
											• 100% Lossless &amp; MD5 Perfect: all files are identical to originals after installation<br>
											• Trial .EXE file ripped, NOTHING re-encoded<br>
											• Significantly smaller archive size (compressed from 50.6 to 33.2 GB)<br>
											• Installation takes: ~30 minutes on 8-threads CPU; ~1 hour on 4-threads CPU<br>
											• After-install integrity check so you could make sure that everything installed properly<br>
											• HDD space after installation: 50 GB (up to 58 GB during installation)<br>
									...
									<div class="img-responsive">
										<img src="img/game/pcgame/bfv/bfv1.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/bfv/bfv2.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/bfv/bfv3.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/bfv/bfv4.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/bfv/bfv5.jpg">
									</div>	
								</div>
							</div>
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/game/pcgame/bfv/bfv7.jpg);">
							<div class="overlay">
								<div class="title">
								<?php
								$sql='SELECT * FROM article WHERE a_id=70';
								...
								<span class="font-size-13">Nov 20, 2018</span>
								
								<div class="bold text-uppercase margin-top-35">Setup</div>
								<span class="font-size-13">• Battlefield V-CPY</span><br>
								<span class="font-size-13">• Battlefield V MULTi14 Repack-FitGirl</span>
								
								<div class="bold text-uppercase margin-top-35">Size</div>
								<span class="font-size-13">• 48.0 GB</span><br>
								<span id="dw" class="font-size-13">• 33.3 GB (fitGirl Repack)</span>
						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								<a href="https://filecrypt.cc/Container/DDD51E6EF7.html" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PC (48.0 GB)</a>
								<a href="https://filecrypt.cc/Container/DED3615732.html" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PC - FitGirl Repack (33.3 GB)</a>
