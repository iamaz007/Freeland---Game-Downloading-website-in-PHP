...
?>	
	...
	<meta name="title" content="Pokemon X & Y | Freeland">
	<meta name="description" content="Download Pokemon X & Y for free from Freeland">
	<meta name="keyword" content="Pokemon X & Y, Pokemon X ,Pokemon Y,Pokemon, Pokemon X & Y 3ds, citra">
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/game/pcgame/pokemonxy/pokemonxy7.jpg)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title">
							<?php
								$sql='SELECT * FROM article WHERE a_id=72';
						  ...
						  <div class="container" style="color:black;">
							<div class="row">
								<div class="col-md-9 padding-right-20">
										<b>Minimum:</b>
										<h5>• OS: Win 10 64-bit</h5>
										<h5>• CPU: i3 or equivalent</h5>
										<h5>• RAM: 8 GB</h5>
										<h5>• Graphics: NVIDIA GT 1030 or Higher</h5>
										<h5>• HARD DRIVE: 5 GB</h5>
							...
							<div class="panel-body">
								<div class="post">
									<div class="post-header post-author">
										...
										<div class="post-title">
											...
											<ul class="post-meta">
												...
												<li><i class="fa fa-calendar-o"></i> Uploaded on: 11 Jan, 2019</li>
									...
									<div class="embed-responsive embed-responsive-16by9 post-thumbnail">
										<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/3NMWdUBA8e4" allowfullscreen></iframe>
									</div>
									<h3><b>Description:</b></h3>
									<div class="wp-tab-content">		
										all-new 3D Pokémon adventure packed with never-before-seen Pokémon has launched! Pokémon X and Pokémon Y presents a new generation of Pokémon and introduces players to an exciting new adventure in a breathtaking 3D world.
...
You'll be able to go on your journey as a boy or a girl, and you can choose how your hero looks overall! Find a look that suits you, and then set off on your travels!				
									...
									<div class="img-responsive">
										<img src="img/game/pcgame/pokemonxy/pokemonxy1.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/pokemonxy/pokemonxy2.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/pokemonxy/pokemonxy3.jpg">
									</div><br>	
								</div>
							</div>
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/game/pcgame/pokemonxy/pokemonxy6.png);">
							<div class="overlay">
								<div class="title">
								<?php
								$sql='SELECT * FROM article WHERE a_id=72';
						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								<a href="https://megaup.net/nah1/EmuCP-PKMNXY.rar" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PC (939 MB)</a>
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							  </div>
