...
?>	
	...
	<meta name="title" content="Battlefield 3 | Freeland">
	<meta name="keyword" content="Battlefield 3 muiltiplayer free download, crack download Battlefield 3, bf3 free download, battlefield campagin">
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/game/pcgame/bf3/bf36.jpg)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title">
							<?php
								$sql='SELECT * FROM article WHERE a_id=60';
...
• Processor: Intel Core 2 Duo @ 2.4 Ghz / AMD Athlon 64 X2 5400+<br>
• Memory: 2 Gb<br>
...
<p>Recommended:<br>
• OS: Windows 7<br>
• Processor: Intel Core 2 Quad @ 2.66 GHz / AMD Phenom II X4 @ 2.8 GHz<br>
• Memory: 4 Gb<br>
• Hard Drive: 20 Gb free<br>
• Video Memory: 1 Gb<br>
• Video Card: nVidia GeForce GTX 560 / ATI Radeon HD 6950<br>
</p>
							...
							<div class="panel-body">
								<div class="post">
									...
									<div class="embed-responsive embed-responsive-16by9 post-thumbnail">
										<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/UIUJh2mA8vg" allowfullscreen></iframe>
									</div>
									<h3><b>Description:</b></h3>
									<div class="wp-tab-content">		
										<div class="wp-tab-content-wrapper">Battlefield 3 leaps ahead of its time with the power of Frostbite 2, the next instalment of DICE’s cutting-edge game engine. This state-of-the-art technology is the foundation on which Battlefield 3 is built, delivering enhanced visual quality, a grand sense of scale, massive destruction, dynamic audio and incredibly lifelike character animations.<p></p>
<p>As bullets whiz by, walls crumble, and explosions throw you to the ground, the battlefield feels more alive and interactive than ever before. In Battlefield 3, players step into the role of the elite U.S. Marines where they will experience heart-pounding missions across diverse locations including Paris, Tehran and New York.</p></div>				
									</div>
									<div id="ss"></div>
									<h3><b><a>Screen Shots:</a></b></h3>
									<div class="img-responsive">
										<img src="img/game/pcgame/bf3/bf31.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/bf3/bf32.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/bf3/bf33.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/bf3/bf34.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/bf3/bf35.jpg">
									</div>	
								</div>
							</div>
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/game/pcgame/bf3/bf37.jpg);">
							<div class="overlay">
								<div class="title">
								<?php
								$sql='SELECT * FROM article WHERE a_id=60';
								...
								<span class="font-size-13">Oct 25, 2011</span>
								
								<div class="bold text-uppercase margin-top-35">Setup</div>
								<span class="font-size-13">Battlefield 3-RELOADED</span>
								
								<div class="bold text-uppercase margin-top-35">Size</div>
								<span id="dw" class="font-size-13">13.5 GB</span>
						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								<a href="http://filecrypt.cc/Container/8A0C64401B.html" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PC (13.5 GB)</a>
								<a href="https://goo.gl/jBySfT" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PS3 (11 GB)</a>
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							  </div>
