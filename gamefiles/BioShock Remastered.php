...
?>	
	...
	<meta name="title" content="BioShock Remastered | Freeland">
	<meta name="description" content="BioShock is a shooter unlike any you’ve ever played, loaded with weapons and tactics never seen.">
	<meta name="keyword" content="BioShock Remastered free download, BioShock Remastered crack only, BioShock Remastered downlaod codex, BioShock Remastered gameplay, BioShock Remastered walkthrough, BioShock Remastered comparison">
	...
	<!-- wrapper -->
	<div id="wrapper">	
		<section class="hero height-350 hero-game img-responsive" style="background-image: url(img/game/pcgame/bsr1/bsr11.jpg)">
			<div class="hero-bg"></div>
			<div class="container">
				<div class="page-header">
					<div class="page-title">
							<?php
								$sql='SELECT * FROM article WHERE a_id=51';
			...
			<div class="container">
				<div class="row">
							...
							<div class="panel-body">
								<div class="post">
									...
									<div class="embed-responsive embed-responsive-16by9 post-thumbnail">
										<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/QtwY33n5WIo" allowfullscreen></iframe>
									</div>
									...
									<div class="img-responsive">
										<img src="img/game/pcgame/bsr1/bsr11.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/bsr1/bsr12.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/bsr1/bsr13.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/bsr1/bsr14.jpg">
									</div><br>
									<div class="img-responsive">
										<img src="img/game/pcgame/bsr1/bsr15.jpg">
									</div>	
								</div>
							</div>
					...
					<div class="col-md-4 padding-left-20">
						<div class="widget widget-game" style="background-image: url(img/game/pcgame/bsr1/bsr13.jpg);">
							<div class="overlay">
								<div class="title">
								<?php
								$sql='SELECT * FROM article WHERE a_id=51';
								...
								<span class="font-size-13">Blind Squirrel</span>
								...
								<span class="font-size-13">BioShock Remastered-CODEX</span>
								
								<div class="bold text-uppercase margin-top-35">Size</div>
								<span id="dw" class="font-size-13">14 GB</span>
						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								<a href="http://filecrypt.cc/Container/7D16EBE921.html" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PC (14 GB)</a>
								<a href="https://drive.google.com/drive/folders/0B0MJNH3nqEdWfnprX0V2YmNCa3hnblFFbjdjdGhHQzZ2WTFLekxVcmZ1aElIcFo3Y2FsV0k" class="btn btn-block btn-primary margin-top-40" target="_blank">Download For PS3 (10.6 GB)</a>
							  Password for PS3 version: vn-sharing.net
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							  </div>
