<!DOCTYPE html>
<html lang="en" class="animated fadeIn" oncontextmenu="return false">
<style>
#but{border:0;background:#343050;color:white;margin:1rem 0;width:auto;text-transform:uppercase;cursor:pointer;}
#but:hover{background-color:#269abc;border-color:#1b6d85;}
</style>
...
<head>
	...
	@import url("https://fonts.googleapis.com/css?family=Permanent");
	font-family:Monsterrat
	</style>
	<!-- FAVICON -->
	<!--<link rel="shortcut icon" href="img/favicon.ico">-->
	<link rel="shortcut icon" href="logo/l3.png">
	<!--no webhost logo-->
	<style>
	...
	<link  href="gamefiles/css/pop.css" rel="stylesheet">
	<link  href="css/pop.css" rel="stylesheet">
    <link href='http://fonts.googleapis.com/css?family=Permanent Marker:400,100,300,500,700' rel='stylesheet' type='text/css'>
	...
	<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
		<script>
		  (adsbygoogle = window.adsbygoogle || []).push({
			google_ad_client: "ca-pub-5025935986803972",
...
<header>
		<div class="container">
			...
			<a href="https://www.freelandpk.tk" class="logo" STYLE="font-family:Permanent Marker">FREELAND<!--<img src="img/logo1.png" alt="">--></a>
			<nav>
					...
					<ul>
						<li class="dropdown">
							...
							<ul class="dropdown-menu default">
								<li><a href="games" class="pagination_link">Games</a></li>
								<li><a href="software">Softwares</a></li>
								<li><a href="https://freelandmovie.000webhostapp.com/" target="_blank">Movies</a></li>
								
							</ul>
						</li>
						<li class="dropdown mega-dropdown mega-dropdown-sm">
							<a href="https://www.freelandpk.tk">Games</a>
							<ul class="dropdown-menu mega-dropdown-menu row">
								<li class="col-md-8">
									<ul>
										<li class="dropdown-header">Choose any category </li>
										<li><a href="../gameCategory/category?cat=action">Action</a></li>
										<li><a href="../gameCategory/category?cat=adventure">Adventure</a></li>
										<li><a href="../gameCategory/category?cat=fighting">Fighting</a></li>
										<li><a href="../gameCategory/category?cat=shooting">Shooting</a></li>
										<li><a href="../gameCategory/category?cat=racing">Racing</a></li>
										<li><a href="../gameCategory/category?cat=horror">Horror</a></li>
										<li><a href="../gameCategory/category?cat=sports">Sports</a></li>
						...
						<li class="dropdown mega-dropdown mega-dropdown-sm">
							<a href="games">Movies</a>
							<ul class="dropdown-menu mega-dropdown-menu row">
								<li class="col-md-3">
									<ul>
										<li class="dropdown-header">Choose any category </li>
										<li><a href="https://freelandmovie.000webhostapp.com/HollywoodMovies" target="_blank">Hollywood</a></li>
										<li><a href="https://freelandmovie.000webhostapp.com//BollywoodMovies" target="_blank">Bollywood</a></li>
										<li><a href="https://freelandmovie.000webhostapp.com//PakistanMovies" target="_blank">Pakistan</a></li>
										<li><a href="https://freelandmovie.000webhostapp.com//tvSeries" target="_blank">Tv Series</a></li>		
									</ul>
								</li>
							</ul>
						</li>
						...
						<li>
							<a href="https://www.freelandpk.tk/software">Softwares</a>
						</li>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu default">
								<li><a href="videoG.html">Games</a></li>
								<li><a href="videoM.html">Movies</a></li>
							</ul>
						</li>
						<li><a href="https://tawk.to/chat/5bf44ffd40105007f378dc45/1csp7hmkq" target="blank">Contact</a></li>
					</ul>
				</div>
			</nav>
			<div class="nav-right">
