...
?>
			...
			<div class="container">
				<div class="page-header">
					...
					<p>All games available at freeland are 100% cracked and free, before installation make sure your antivirus is off and if any game is not available at Freeland then contact to admin.</p>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
								...
								<?php
									...
									$sql='SELECT * FROM article ORDER BY a_id desc LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
									$result = mysqli_query($con, $sql);
